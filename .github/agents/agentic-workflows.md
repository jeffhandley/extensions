...
When **creating** or **updating** an agentic workflow, always include the following frontmatter that integrates the PAT pool, as found in as detailed in the **Usage** sectoin of `.github/workflows/shared/pat_pool.README.md`. This should be used verbatim when first added.
